...
public:
    ...
    CUDA_CALLABLE_MEMBER complex<_Tp> operator~ ()
    {
    	return complex(__re_, -__im_);
    }
...
public:
    ...
    CUDA_CALLABLE_MEMBER complex<float> operator~ () const
    {
    	return complex(__re_, -__im_);
    }
...
public:
    ...
    CUDA_CALLABLE_MEMBER complex& operator/=(double __re) {__re_ /= __re; __im_ /= __re; return *this;}
        ...
        CUDA_CALLABLE_MEMBER complex<double> operator~ () const
    {
    	return complex(__re_, -__im_);
    }
